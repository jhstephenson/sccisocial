namespace :fill do
  ...
  task data: :environment do
    ...
    user = User.new(name: 'Rails', email: 'jstephen@scc-i.com', sex: 'female', password: 'password')
    user.skip_confirmation!
    user.save!
    puts 'Created test user with email=jstephen@scc-i.com and password=password'
